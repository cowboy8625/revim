...
impl StatusBar {
    ...
    fn update(&self, file_type: String, mode: &Mode, cursor: Vector) {
        //  So the args above are in a Vec and so i now what order they are in at the moment but in
        //  6 months i cant be bothered to remember that.  i need a way to update them with out the
        //    hassle of indexing.
